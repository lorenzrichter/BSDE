...
#problem = LLGC(d=2)
sol = Solver('test', problem, K=100, L=1000, time_approx='inner',approx_method='control',lr = 0.01, loss_method='cross_entropy')
#pt.manual_seed(42)
...
#do_importance_sampling(problem, sol, 10000, control='true', verbose=True, delta_t=0.01)
do_importance_sampling(problem, sol, 10000, control='approx', verbose=True, delta_t=0.005)
